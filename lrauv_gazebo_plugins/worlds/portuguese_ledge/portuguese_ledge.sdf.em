...
<!--
  ...
  This world contains a single LRAUV vehicle, tethys, and the portuguese ledge.
...
@[end for]@
  ...
  <model name="target_marker">
    <static>true</static>
    <pose>-70.23 -36.13 -14.75 0 0 0</pose>
    <link name="link">
      <visual name="visual">
        <geometry>
          <sphere>
        ...
        <material>
          <ambient>0.6 0.0 0.0 1.0</ambient>
          <diffuse>0.6 0.0 0.0 1.0</diffuse>
          <emissive>0.6 0.0 0.0 1.0</emissive>
        </material>
      </visual>
    </link>
  </model>
